...
# deltaFrq = 0.1 # Descomentar para prueba 2
...
print(f'Se toma el rango de {deltaFrq} [Hz] alrededor de la frecuencia predominante')
...
print(f'Se seleccionan {puntos} frecuencia/s en este rango')
...
# write('handel_fftinv_original.wav', rate, fftinv) # Método 1 escritura en .wav
# write('handel_fftinv_inversa_fixed.wav', rate, fftinv) # Método 1 escritura en .wav
